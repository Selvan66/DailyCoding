...
/* In a future release of Bison, this section will be replaced
   by #include "timeParser.tab.h".  */
#ifndef YY_YY_TIMEPARSER_TAB_H_INCLUDED
# define YY_YY_TIMEPARSER_TAB_H_INCLUDED
/* Enabling traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
{
/* Line 387 of yacc.c  */
#line 10 "timeParser.y"
int num; char id;

/* Line 387 of yacc.c  */
#line 127 "timeParser.tab.c"
} YYSTYPE;
...
#endif /* !YY_YY_TIMEPARSER_TAB_H_INCLUDED  */

/* Copy the second part of user declarations.  */

/* Line 390 of yacc.c  */
#line 155 "timeParser.tab.c"
...
{
  "$end", "error", "$undefined", "noon", "number", "':'", "'\\n'",
  "$accept", "time", YY_NULL
};
#endif
...
{
       6,     1,     8,     9,     7,     3,     0,     4,     5,    10,
      13,    11,    12,    14,    18,    15,    16,    19,     0,    17,
      20
};
...
#line 19 "timeParser.y"
  ...
  case 4:
/* Line 1792 of yacc.c  */
#line 20 "timeParser.y"
    {isHourValid((yyvsp[(1) - (3)].num), 1); printf("%d:%d\n", getNoonTime((yyvsp[(1) - (3)].num), (yyvsp[(2) - (3)].id)));}
    break;

  case 5:
/* Line 1792 of yacc.c  */
#line 21 "timeParser.y"
    {isHourValid((yyvsp[(1) - (2)].num), 0); printf("%d:%d\n", (yyvsp[(1) - (2)].num));}
    break;
...
#line 23 "timeParser.y"
  ...
  case 8:
/* Line 1792 of yacc.c  */
#line 24 "timeParser.y"
    {isHourValid((yyvsp[(2) - (4)].num), 1); printf("%d:%d\n", getNoonTime((yyvsp[(2) - (4)].num), (yyvsp[(3) - (4)].id)));}
    break;

  case 9:
/* Line 1792 of yacc.c  */
#line 25 "timeParser.y"
    {isHourValid((yyvsp[(2) - (3)].num), 0); printf("%d:%d\n", (yyvsp[(2) - (3)].num));}
    break;


/* Line 1792 of yacc.c  */
#line 1392 "timeParser.tab.c"
      default: break;
    }
